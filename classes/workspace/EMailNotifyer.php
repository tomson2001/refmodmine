...
class EMailNotifyer {
	...
	public static function sendCLIModelMatcherNotification($to, $readme) {
		return self::send($to, "Your process matching results", $readme);
	}
	...
	public static function sendAdminCleanupReport($report) {
		return self::send(Config::ADMIN_E_MAIL, "RMMaaS Cleanup Report", $report);
	}
