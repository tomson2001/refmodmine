<?php
/**
 * Mapping Kalkulator - Speziell fuer den Mapping-Contest der BPM2013 konzipiert, but with output format of the PMC 2015:
...
// ReadMe.txt erzeugen
$readme = "--------------------------------------------------------------------------\r\n";
$readme .= " RMMaaS - Process Matching - N-Ary Semantic Cluster Matching (PMC2015)\r\n";
$readme .= "--------------------------------------------------------------------------\r\n\r\n";
$readme .= "Log:\r\n";
