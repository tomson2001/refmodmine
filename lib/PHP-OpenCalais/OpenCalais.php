...
class OpenCalais {
    ...
    /**
     * Return a string of the entities
     */
    public static function transformEntitiesToString($entities) {
    	$string = "";
    	$i = 0;
    ...
    /**
     * Returns an array of tags only, without categories
     */
    public static function getTagsOnly($entities) {
    	$arr = array();
    	foreach ($entities as $type => $values) {
    		foreach ($values as $entity) {
    			$arr[] = $entity;
